...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='infinex.conf'
CONFIGFOLDER='/root/.infinexcore'
COIN_DAEMON='infinexd'
COIN_CLI='infinex-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/zoldur/Infinex/releases/download/v1.0.0.0/infinex.tar.gz'
